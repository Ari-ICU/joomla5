...
?><?php
class hikashopCategorysubType extends hikashopType {
	var $type = 'tax';
	var $value = '';
...
';
	...
	private function getData($type = 'product', $root = 0, $displayRoot = false, $selectRoot = false, $value = null) {
		...
		$parents = $categoryClass->getParents($value, 0, array('category_id', 'category_left', 'category_right', 'category_name', 'category_parent_id'));
